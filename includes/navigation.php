    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #182c39;" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Bus Ticket Booking System</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="registration.php"><i class="fa fa-fw fa-desktop"></i>Sign Up</a>
                    </li>
...
>
                            ...
                            <li class="dropdown">
                                ...
                                //echo $_SESSION['s_username']; ?> <b class="caret"></b></a>
